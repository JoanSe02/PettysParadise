        ...
        <div className="container">
          <div className="header-content">
            ...
            <nav className="desktop-nav1">
              <Link to="/" className={`nav-link1 ${isActive('/') ? 'active' : ''}`}>
                Inicio
              </Link>
              <Link to="/#servicios" className={`nav-link1 ${isActive('/#servicios') ? 'active' : ''}`}>
                  Servicios
              </Link>
              <Link to="/nosotros" className={`nav-link1 ${isActive('/nosotros') ? 'active' : ''}`}>
                Nosotros
              </Link>
              <Link to="/#blog" className={`nav-link1 ${isActive('/#blog') ? 'active' : ''}`}>
                Blog
              </Link>
